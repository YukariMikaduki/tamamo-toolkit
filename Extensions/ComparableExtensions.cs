namespace TamamoToolkit.Extensions
{
    ...
    public static class ComparableExtensions
    {
        ...
        extension<T>(ref T value) where T : struct, IComparable<T>
        {
            /// <summary>
            ...
            /// name="min"/>，否则返回 <paramref name="value"/>
            /// </returns>
            public ref T SetLowerLimits(T min)
            {
            ...
            /// <para>
            /// 当 <paramref name="value"/> 大于上限 <paramref name="max"/> 时，会被重新赋值为 <paramref
            /// name="max"/>； 当 <paramref name="value"/> 小于下限 <paramref name="min"/> 时，会被重新赋值为
            ...
            /// <param name="min">下限值</param>
            /// <returns>
            /// 当 <paramref name="value"/> 小于下限 <paramref name="min"/> 时，返回 <paramref name="min"/>；
            /// 当 <paramref name="value"/> 大于上限 <paramref name="max"/> 时，返回 <paramref
            /// name="max"/>；其余情况返回 <paramref name="value"/>
            /// </returns>
            public ref T SetUpperAndLowerLimits(T max, T min)
            {
            ...
            /// <returns>
            /// 当 <paramref name="value"/> 大于上限 <paramref name="max"/> 时，返回 <paramref
            /// name="max"/>，否则返回 <paramref name="value"/>
            /// </returns>
            public ref T SetUpperLimits(T max)
            {
