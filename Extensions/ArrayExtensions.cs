namespace TamamoToolkit.Extensions
{
    ...
    public static class ArrayExtensions
    {
        ...
        extension<T>(T?[] array)
        {
            ...
            /// </summary>
            /// <exception cref="ArgumentNullException">array 为 <see langword="null"/> 时拋出的异常</exception>
            public void Clear()
            {
            ...
            /// name="startIndex"/> 与 <paramref name="count"/> 之和大于 array 长度时拋出的异常
            /// </exception>
            ...
            /// array 为 <see langword="null"/>，或 <paramref name="filler"/> 为 <see langword="null"/> 时拋出的异常
            /// </exception>
            /// <exception cref="ArgumentOutOfRangeException">
            /// <paramref name="startIndex"/> 小于 0，或 <paramref name="count"/> 小于 0，或 <paramref
            /// name="startIndex"/> 与 <paramref name="count"/> 之和大于 array 长度时拋出的异常
            /// </exception>
            public void Fill(Func<T> filler, int startIndex, int count)
            {
                ArgumentNullException.ThrowIfNull(array);
            ...
            /// array 为 <see langword="null"/>，或 <paramref name="filler"/> 为 <see langword="null"/> 时拋出的异常
            /// </exception>
            public void Fill(Func<T> filler)
            {
                ArgumentNullException.ThrowIfNull(array);
                ArgumentNullException.ThrowIfNull(filler);
